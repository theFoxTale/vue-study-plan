...
- работа с типами в store и router — [теория, Pinia state, route params/query, bridge к Module 5–6, ссылки](docs/module-4/07-types-in-store-and-router.md)
...
- корзина товаров — [практический checklist](docs/module-6/10-practice-checklist.md)
- избранное
...
- список пользователей — [практический checklist](docs/module-7/10-practice-checklist.md)
- каталог товаров
- поиск по API
...
- cache lifecycle — [теория, staleTime, gcTime, refetch triggers, fresh/stale, gc](docs/module-8/08-cache-lifecycle.md)

### Практика

- переделать API-часть одного проекта на `vue-query`
- реализовать список + деталку + обновление данных
- [практический checklist](docs/module-8/09-practice-checklist.md)
...
- многошаговая форма
- [практический checklist](docs/module-9/08-practice-checklist.md)
...
- [практический checklist](docs/module-10/07-practice-checklist.md)
...
- [практический checklist](docs/module-11/10-practice-checklist.md)
...
- [практический checklist](docs/module-12/11-practice-checklist.md)
...
- базовые принципы масштабируемости — [теория, границы, blast radius, contracts, evolution](docs/module-13/09-scalability.md)

### Практика

- переразложить один учебный проект в более зрелую архитектуру
- написать короткие архитектурные правила проекта
- [практический checklist](docs/module-13/10-practice-checklist.md)
...
- [практический checklist](docs/module-15/01-practice-checklist.md)
